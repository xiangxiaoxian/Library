	...
	<div class="left-nav">
		<div id="side-nav">
			<ul id="nav">
				...
				<!-- 示例：这是一个下拉菜单 -->
				<li><a href="javascript:;"> <i class="iconfont">&#xe6f2;</i> <cite>图书管理</cite> <i
						class="iconfont nav_right">&#xe697;</i>
				</a>
					<ul class="sub-menu">
						<!-- 这是一个普通按钮 -->
						<li><a _href="${pageContext.request.contextPath}/bc/bookList.do"> <i
								class="iconfont">&#xe6a7;</i> <cite>图书信息</cite>
						</a></li>
						<!-- 按钮结束 -->
				...
				<cite>权限管理</cite> <i
					...
					<ul class="sub-menu">
						<li><a _href="${pageContext.request.contextPath}/rc/FPP.do"> <i class="iconfont">&#xe6a7;</i> <cite>职工权限分配</cite>
						</a></li>
						<li><a _href="${pageContext.request.contextPath}/pc/manage.do"> <i class="iconfont">&#xe6a7;</i> <cite>管理权限</cite>
						</a></li>
						<li><a _href="${pageContext.request.contextPath}/rc/query.do"> <i class="iconfont">&#xe6a7;</i> <cite>管理员信息</cite>
						</a></li>
					</ul></li>
				</shiro:hasRole>
				<!-- 示例结束 -->
		...
		<div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<iframe src='${pageContext.request.contextPath}/showWelcome.do' frameborder="0" scrolling="yes"
